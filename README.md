...
- Change password (and username if needed) inside `DATABASE_URL` to your credentials
...
### 8. You're all set to test now! Scroll down to "Verifying Account Creation (Vertical Slice)" to see what to test!
